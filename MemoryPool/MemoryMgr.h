...
protected:
	MemoryAllocator<64, 10240> m_mem64;
	MemoryAllocator<128, 10240> m_mem128;
	MemoryAllocator<256, 10240> m_mem256;
	MemoryAllocator<512, 10240> m_mem512;
	MemoryAllocator<1024, 10240> m_mem1024;
	MemoryAllocator<2048, 10240> m_mem2048;
	MemoryAllocator<4096, 10240> m_mem4096;
	//无查找定位到链表
